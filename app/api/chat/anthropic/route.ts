...
export async function POST(request: NextRequest) {
  ...
  // console.log("Slice messsage", messages.slice(1));
  ...
  try {
    ...
    // console.log("ANTHROPIC_FORMATTED_MESSAGES", ANTHROPIC_FORMATTED_MESSAGES);

    let lastMessage =
      ANTHROPIC_FORMATTED_MESSAGES.length > 0
        ? ANTHROPIC_FORMATTED_MESSAGES[ANTHROPIC_FORMATTED_MESSAGES.length - 1]
        : null
